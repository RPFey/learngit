...
class SimServer:
    def __init__(self,filename,world_type=1):
        ...
        self.map_sub=rospy.Subscriber("/map",OccupancyGrid,self.__recv_map)
        self.map=None
    ...
    def serve(self,port=8880):
        ...
        while not self.isEnd:
            ...
            if type == "tws":
                ...
                self.send_map_to_client()
            elif type=="end":
                self.isEnd=True
                self.connection.close()


    def send_pose_to_client(self):
